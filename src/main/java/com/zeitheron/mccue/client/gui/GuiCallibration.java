...
import com.zeitheron.mccue.client.sdk.corsair.icue.DeviceType;
		...
		extends GuiScreen
{
	...
	public static ResourceLocation tex(DeviceType type, int layer)
	{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		} else
		{
			...
			float strength = (float) (1.0 + Math.sin(Math.toRadians((float) (System.currentTimeMillis() % 3600L) / 10.0f))) / 4.0f;
