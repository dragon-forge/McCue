...
import org.zeith.mccue.client.sdk.corsair.icue.jna.CorsairLedColor;
...
public class LedColor
{
	...
	public LedColor(CorsairLedId ledId, int r, int g, int b)
	{
		this(ledId.ordinal(), r, g, b);
	}

	public LedColor(CorsairLedId ledId, int rgb)
	{
		this(ledId.ordinal(), rgb >> 16 & 255, rgb >> 8 & 255, rgb >> 0 & 255);
	}

	public LedColor(CorsairLedId ledId, Color color)
	{
