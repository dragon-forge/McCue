...
import org.zeith.mccue.api.sdk.SDKControlStack;
import org.zeith.mccue.client.sdk.corsair.icue.jna.*;
		...
		implements ICueSDK
{
	...
	public CueSDK(boolean exclusiveLightingControl, Configuration cfg)
	{
		...
		this.presets = new ICueCalibrationPresets(this);
	...
	public Optional<Consumer<int[]>> createRgbSink(String led)
	{
		try
		{
			return Optional.of(new ICueSDKColorSink(this, CorsairLedId.valueOf(led)));
		} catch(Throwable err)
		{
	...
	public String getPeripheralByLed(String led)
	{
		try
		{
			CorsairLedId id = CorsairLedId.valueOf(led);
