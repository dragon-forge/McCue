...
import com.sun.jna.*;
import org.zeith.mccue.client.sdk.razer.chroma.jna.devices.*;

/**
 * Wrapper used by JNA to load Razer Chroma SDK libraries.
 */
interface JChromaLib
		extends Library
{
	String JNA_LIBRARY_NAME = "CChromaEditorLibrary";
	NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(JNA_LIBRARY_NAME);
	JChromaLib INSTANCE = Native.loadLibrary(JNA_LIBRARY_NAME, JChromaLib.class);
